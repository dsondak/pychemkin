...
#     xml_filename =  "test_xml_files/rxn.xml"
...
#     xml_filename =  "test_xml_files/rxns_mixed.xml"
#     parser = XMLParser(xml_filename)
...
#     xml_filename =  "test_xml_files/rxnsys.xml"
#     parser = XMLParser(xml_filename)
#     temp = 10
...
#     xml_filename =  "test_xml_files/rev_rxn.xml"
#     parser = XMLParser(xml_filename)
#     temp = 500 # "low" temperature range in NASA coeffs database
#     concentrations = {'H':1, 'O2':1, 'H2O':1}
#     rxnsys = ReactionSystem(parser.reaction_list, parser.NASA_poly_coefs, temp, concentrations)
